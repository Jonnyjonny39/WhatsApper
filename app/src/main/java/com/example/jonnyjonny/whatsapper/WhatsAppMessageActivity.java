...
public class WhatsAppMessageActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this,"Chat With"+selectedUser+"Now!",Toast.LENGTH_SHORT).show();
    ...
    public void onClick(View v) {
        ...
        chat.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                if (e==null){
                    Toast.makeText(WhatsAppMessageActivity.this,"Message From"+ParseUser.getCurrentUser().getUsername()+"sent to"+selectedUser,Toast.LENGTH_SHORT).show();
